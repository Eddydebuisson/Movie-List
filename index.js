...
(function () {
    ...
    axios.get("bd.json").then((response) => {
    ...
    function showMovie (id) {
      ...
      axios.get("bd.json").then(response => {
        ...
        modalImage.innerHTML = `<img src="${data[id].images}" class="img-fluid" alt="Responsive image">`
        modalDate.textContent = `release at : ${data[id].release_date}`
        modalDescription.textContent = `${data[id].description}`
      })
    }
